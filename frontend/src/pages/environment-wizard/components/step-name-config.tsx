    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
          <label htmlFor="friendly-name" className="text-content-primary text-sm font-medium">
        ...
        <div className="space-y-2">
          <label htmlFor="env-name" className="text-content-primary text-sm font-medium">
