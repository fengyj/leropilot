...
# Resource directory uses hyphenated names (e.g., 'koch-follower'), accept that here
GOOD_URDF = resource_files.joinpath("robots").joinpath("koch-follower").joinpath("robot.urdf")
