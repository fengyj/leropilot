...
class TestMotorBusArchitecture:
    ...
    def test_can_motor_bus_creation(self):
    ...
    def test_serial_motor_bus_scan(self):
    ...
    def test_motor_bus_context_manager(self):
    ...
    def test_motorbus_factory(self):
