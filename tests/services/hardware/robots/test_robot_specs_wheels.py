...
def test_lekiwi_wheel_motors_not_need_calibration():
    ...
    # First three motors (ids 17,18,19) are wheels and should have is_full_turn True
    ...
    for wid in wheel_ids:
        ...
        assert found.is_full_turn is True, f"Wheel motor {wid} should have is_full_turn True"
