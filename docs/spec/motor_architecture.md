...
- Responsibilities:
  ...
  - Provide `read_telemetry`, `set_position`, `set_torque`, `reboot`, `bulk_read_telemetry` optimized for the motor family
...
class MotorDriver(ABC):
    ...
    def bulk_read_telemetry(self, motor_ids: list[int]) -> dict[int, MotorTelemetry]: ...
